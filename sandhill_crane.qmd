...
# from landmapy.gbif import ecoregions, gbif_ecoregion
# from landmapy.gbif import count_monthly_ecoregions, count_yearly_ecoregions
# from landmapy.gbif import simplify_ecoregions_gdf, join_occurrence, hvplot_occurrence
...
```{python}
occurrence_df = count_monthly_ecoregions(gbif_ecoregion_gdf, 'ecoregion', 'name')
occurrence_df
```
